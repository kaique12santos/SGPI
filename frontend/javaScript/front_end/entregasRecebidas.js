...
async function carregarEntregasRecebidas() {
  ...
  try {
    const data = await obterEntregasRecebidas(professorId);
...
// função global opcional se você ainda precisar usar onclick no HTML
window.avaliar = function (entregaId) {
