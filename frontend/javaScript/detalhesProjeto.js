...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Função para obter o query param “projetoId” da URL
    function getQueryParam(chave) {
      const params = new URLSearchParams(window.location.search);
      return params.get(chave);
    }
  
    // Logo que a página carregar, já tentamos buscar as atividades
    (async () => {
      ...
      try {
        // Rota: /coordenador/projetos/:projetoId/atividades
        const resposta = await fetch(`/coordenador/projetos/${encodeURIComponent(projetoId)}/atividades`);
        ...
        atividades.forEach(atv => {
          ...
          tdNota.textContent = (atv.NOTA_AVALIACAO !== null ? atv.NOTA_AVALIACAO : '-');
        ...
        erro.textContent = 'Erro ao carregar atividades. Tente novamente mais tarde.';
      }
    })();
  });
